...
CREATE TABLE cliente(
    ...
    numero INT NOT NULL,  -- Corrigido para INT
...
VALUES
(12345678910, "Ana Claudia", "Cunha", "2014-09-17", 63.50, 1.73, "+5511989898988", "ana.cscunha1@senacsp.edu.br", "Rua Dr Antônio Bento", 393, "", "04750000");
...
-- Alterando dois registros diferentes na tabela cliente
UPDATE cliente
SET peso = 66.50, datanasc = "2000-09-17"
WHERE cpf = 12345678910;

-- Read - Selecionando todos os dados da tabela treino
SELECT * FROM treino;
